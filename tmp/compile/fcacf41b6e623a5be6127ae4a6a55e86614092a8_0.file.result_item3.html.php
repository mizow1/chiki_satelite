...
/* Smarty version 4.1.1, created on 2023-12-18 16:39:24
  from '/home/users/0/flier.jp-uranai/web/uranai/chiki/webapp/view/index/default_smp/parts/result_item3.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_657ff72c6781c3_86133351',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fcacf41b6e623a5be6127ae4a6a55e86614092a8' => 
    array (
      0 => '/home/users/0/flier.jp-uranai/web/uranai/chiki/webapp/view/index/default_smp/parts/result_item3.html',
      1 => 1702880232,
      2 => 'file',
    ),
  ),
...
function content_657ff72c6781c3_86133351 (Smarty_Internal_Template $_smarty_tpl) {
		...
		<?php if (empty($_smarty_tpl->tpl_vars['menu_data']->value['pickup_flag']) && ($_smarty_tpl->tpl_vars['page_identify']->value == (defined('PAY') ? constant('PAY') : null) || $_smarty_tpl->tpl_vars['page_identify']->value == (defined('FREE') ? constant('FREE') : null))) {?>
			<div class="ow_star_figure">
				<div class="ow_star_bg">
					<img src="img/smp/result/star_bg.jpg" alt="十大主星/十二徒星★陽占図" title="十大主星/十二徒星★陽占図">
				</div>
				<div class="ow_area_item ow_star_figure_ten ow_star_figure_ten_2">
					<img src="img/smp/result/star/ten/<?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['my_graph_2']['star_num'];?>
.png" alt="">
				</div>
				<div class="ow_area_item ow_star_figure_twelve ow_star_figure_twelve_3">
					<img src="img/smp/result/star/twelve/<?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['my_graph_3'];?>
.png" alt="">
				</div>
				<div class="ow_area_item ow_star_figure_ten ow_star_figure_ten_4">
					<img src="img/smp/result/star/ten/<?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['my_graph_4']['star_num'];?>
.png" alt="">
				</div>
				<div class="ow_area_item ow_star_figure_ten ow_star_figure_ten_5">
					<img src="img/smp/result/star/ten/<?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['my_graph_5']['star_num'];?>
.png" alt="">
				</div>
				<div class="ow_area_item ow_star_figure_ten ow_star_figure_ten_6">
					<img src="img/smp/result/star/ten/<?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['my_graph_6']['star_num'];?>
.png" alt="">
				</div>
				<div class="ow_area_item ow_star_figure_twelve ow_star_figure_twelve_7">
					<img src="img/smp/result/star/twelve/<?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['my_graph_7'];?>
.png" alt="">
				</div>
				<div class="ow_area_item ow_star_figure_ten ow_star_figure_ten_8">
					<img src="img/smp/result/star/ten/<?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['my_graph_8']['star_num'];?>
.png" alt="">
				</div>
				<div class="ow_area_item ow_star_figure_twelve ow_star_figure_twelve_9">
					<img src="img/smp/result/star/twelve/<?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['my_graph_9'];?>
.png" alt="">
				</div>
...
">
					<img src="img/smp/result/star/star_figure_hikari.png" alt="">
				</div>
			</div>
	...
	<?php if ($_smarty_tpl->tpl_vars['star_num']->value == 3 || $_smarty_tpl->tpl_vars['star_num']->value == 7 || $_smarty_tpl->tpl_vars['star_num']->value == 9) {?>
					<div class="ow_star_twelve ow_tac">
						<img src="img/smp/result/star/star_twelve.png" alt="あなたの十二大主星" title="あなたの十二大主星">
					</div>
	<?php } else { ?>
					<div class="ow_star_ten ow_tac">
						<img src="img/smp/result/star/star_ten.png" alt="あなたの十大主星" title="あなたの十大主星">
					</div>
	<?php }?>
			...
			<div class="ow_star_figure_btm ow_tac">
				<img class="ow_vat" src="img/smp/result/star/star_figure_btm.jpg" alt="" title="">
			</div>
		<?php } else { ?>
			<img src="img/smp/nc/star_bg.png" alt="有料版ではあなたの十大主星と十二大従星がわかります" title="有料版ではあなたの十大主星と十二大従星がわかります">
		<?php }?>
...
運についてのお悩みは<br/><?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['my_graph_text'][$_smarty_tpl->tpl_vars['star_num']->value];?>
が答えを導きます
		<?php } else { ?>
			あなたの<?php echo $_smarty_tpl->tpl_vars['base_data']->value['result_category'];?>
	...
	<div class="ow_result_item_mid">
		...
		<?php if (empty($_smarty_tpl->tpl_vars['menu_data']->value['pickup_flag']) && ($_smarty_tpl->tpl_vars['page_identify']->value == (defined('PAY') ? constant('PAY') : null) || $_smarty_tpl->tpl_vars['page_identify']->value == (defined('FREE') ? constant('FREE') : null))) {?>
			<div class="ow_star_figure">
				...
				<div class="ow_area_item ow_star_figure_ten ow_star_figure_ten_2">
					<img src="img/smp/result/star/ten/<?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['target_graph_2']['star_num'];?>
.png" alt="">
				</div>
				<div class="ow_area_item ow_star_figure_twelve ow_star_figure_twelve_3">
					<img src="img/smp/result/star/twelve/<?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['target_graph_3'];?>
.png" alt="">
				</div>
				<div class="ow_area_item ow_star_figure_ten ow_star_figure_ten_4">
					<img src="img/smp/result/star/ten/<?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['target_graph_4']['star_num'];?>
.png" alt="">
				</div>
				<div class="ow_area_item ow_star_figure_ten ow_star_figure_ten_5">
					<img src="img/smp/result/star/ten/<?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['target_graph_5']['star_num'];?>
.png" alt="">
				</div>
				<div class="ow_area_item ow_star_figure_ten ow_star_figure_ten_6">
					<img src="img/smp/result/star/ten/<?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['target_graph_6']['star_num'];?>
.png" alt="">
				</div>
				<div class="ow_area_item ow_star_figure_twelve ow_star_figure_twelve_7">
					<img src="img/smp/result/star/twelve/<?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['target_graph_7'];?>
.png" alt="">
				</div>
				<div class="ow_area_item ow_star_figure_ten ow_star_figure_ten_8">
					<img src="img/smp/result/star/ten/<?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['target_graph_8']['star_num'];?>
.png" alt="">
				</div>
				<div class="ow_area_item ow_star_figure_twelve ow_star_figure_twelve_9">
					<img src="img/smp/result/star/twelve/<?php echo $_smarty_tpl->tpl_vars['base_data']->value['base_list']['target_graph_9'];?>
.png" alt="">
				</div>
				<div class="ow_area_item ow_star_figure_hikari ow_star_figure_hikari_<?php echo $_smarty_tpl->tpl_vars['menu_data']->value['result_category'];?>
">
	...
	<?php if ($_smarty_tpl->tpl_vars['star_num']->value == 3 || $_smarty_tpl->tpl_vars['star_num']->value == 7 || $_smarty_tpl->tpl_vars['star_num']->value == 9) {?>
					<div class="ow_star_twelve ow_tac">
						<img src="img/smp/result/star/star_twelve2.png" alt="あの人の十二大主星" title="あなたの十二大主星">
					</div>
	<?php } else { ?>
					<div class="ow_star_ten ow_tac">
						<img src="img/smp/result/star/star_ten2.png" alt="あの人の十大主星" title="あなたの十大主星">
					</div>
	<?php }?>
					<div class="ow_area_item ow_figure_result_text">
