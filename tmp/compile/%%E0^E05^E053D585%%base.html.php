<?php /* Smarty version 2.6.18, created on 2023-12-13 19:25:22
         compiled from file:./parts/base.html */ ?>
<!-- ▽▽▽結果 基本性格▽▽▽ -->
<!-- BASE -->
	...
	<div class="ow_base_main ow_tac">
		<div class="ow_anata">
			...
			<div class="ow_base_date ow_anata_item">
				<?php echo $this->_tpl_vars['base_data']['entry_data']['yy1']; ?>
年<?php echo $this->_tpl_vars['base_data']['entry_data']['mm1']; ?>
月<?php echo $this->_tpl_vars['base_data']['entry_data']['dd1']; ?>
日
			</div>
			<div class="ow_base_seibetu ow_anata_item">
					<?php if ($this->_tpl_vars['base_data']['entry_data']['sex1'] == 1): ?>男性
					<?php else: ?>女性
					<?php endif; ?>
			</div>
		</div>
		...
		<div class="ow_base_jutu">
			...
			<div class="ow_jutu_result">
				...
				<div class="ow_jutu_nisshi ow_base_jutu_item">
					<img src="img/pc/result/nisshi/<?php echo $this->_tpl_vars['base_data']['base_list']['my_time_num_dd']; ?>
.png" alt="">
				</div>
				<!-- ow_nesshi -->
				<div class="ow_jutu_gesshi ow_base_jutu_item">
					<img src="img/pc/result/gesshi/<?php echo $this->_tpl_vars['base_data']['base_list']['my_time_num_mm']; ?>
.png" alt="">
				</div>
				<!-- ow_nesshi -->
				<div class="ow_jutu_nesshi ow_jutu_result_item ow_base_jutu_<?php echo $this->_tpl_vars['base_data']['base_list']['my_etonum_yy']; ?>
">
			...
			<div class="ow_base_result">
				...
				<div class="ow_base_result_mid">
					<div class="ow_zodiac">
						...
						<div class="ow_zodiac_nisshi ow_zodiac_item"><img src="img/pc/result/base_result/<?php echo $this->_tpl_vars['base_data']['base_list']['my_time_num_dd']; ?>
.png" alt=""></div>
						<div class="ow_zodiac_gesshi ow_zodiac_item"><img src="img/pc/result/base_result/<?php echo $this->_tpl_vars['base_data']['base_list']['my_time_num_mm']; ?>
.png" alt=""></div>
						<div class="ow_zodiac_nenshi ow_zodiac_item"><img src="img/pc/result/base_result/<?php echo $this->_tpl_vars['base_data']['base_list']['my_time_num_yy']; ?>
.png" alt=""></div>
					...
					<div class="ow_show">
						...
						<div class="ow_show_heart_text ow_show_item">
							<?php if (empty ( $this->_tpl_vars['menu_data']['pickup_flag'] ) && ( $this->_tpl_vars['page_identify'] == @PAY )): ?>
								<?php echo $this->_tpl_vars['base_data']['base_list']['my_base_text_mm']; ?>
						...
						<div class="ow_show_work_text ow_show_item">
							<?php echo $this->_tpl_vars['base_data']['base_list']['my_base_text_yy']; ?>
...
日
			...
			<div class="ow_base_date_anohito ow_anohito_item">
				<?php echo $this->_tpl_vars['base_data']['entry_data']['yy2']; ?>
年<?php echo $this->_tpl_vars['base_data']['entry_data']['mm2']; ?>
月<?php echo $this->_tpl_vars['base_data']['entry_data']['dd2']; ?>
日
			</div>
			<div class="ow_base_seibetu_anohito ow_anohito_item">
					<?php if ($this->_tpl_vars['base_data']['entry_data']['sex2'] == 1): ?>男性
					<?php else: ?>女性
					<?php endif; ?>
			</div>
		</div>
		...
		<div class="ow_base_jutu">
			...
			<div class="ow_jutu_result">
				...
				<!-- ow_nisshi -->
				<div class="ow_jutu_nisshi ow_base_jutu_item">
					<img src="img/pc/result/nisshi/<?php echo $this->_tpl_vars['base_data']['base_list']['target_time_num_dd']; ?>
.png" alt="">
				</div>
				<!-- ow_nesshi -->
				<div class="ow_jutu_gesshi ow_base_jutu_item">
					<img src="img/pc/result/gesshi/<?php echo $this->_tpl_vars['base_data']['base_list']['target_time_num_mm']; ?>
.png" alt="">
				</div>
				<!-- ow_nesshi -->
				<div class="ow_jutu_nesshi ow_jutu_result_item ow_base_jutu_<?php echo $this->_tpl_vars['base_data']['base_list']['target_etonum_yy']; ?>
">
					<img src="img/pc/result/nenshi/1.png" alt="">
				</div>
			</div>
		...
		<div class="ow_result_item ow_jixtukan">
			<div class="ow_base_result">
				...
				<div class="ow_base_result_mid">
						<div class="ow_zodiac">
							<div class="ow_zodiac_bg ow_tac"><img src="img/pc/result/base_result/base_result_zodiac.png" alt=""></div>
							<div class="ow_zodiac_nisshi ow_zodiac_item"><img src="img/pc/result/base_result/<?php echo $this->_tpl_vars['base_data']['base_list']['target_time_num_dd']; ?>
.png" alt=""></div>
							<div class="ow_zodiac_gesshi ow_zodiac_item"><img src="img/pc/result/base_result/<?php echo $this->_tpl_vars['base_data']['base_list']['target_time_num_mm']; ?>
.png" alt=""></div>
							<div class="ow_zodiac_nenshi ow_zodiac_item"><img src="img/pc/result/base_result/<?php echo $this->_tpl_vars['base_data']['base_list']['target_time_num_yy']; ?>
.png" alt=""></div>
							<div class="ow_zodiac_shadow_1 ow_zodiac_item"><img src="img/pc/result/base_result/shadow.png" alt=""></div>
							<div class="ow_zodiac_shadow_2 ow_zodiac_item"><img src="img/pc/result/base_result/shadow.png" alt=""></div>
							<div class="ow_zodiac_shadow_3 ow_zodiac_item"><img src="img/pc/result/base_result/shadow.png" alt=""></div>
						...
						<div class="ow_show">
							...
							<div class="ow_show_heart_text ow_show_item">
							<?php if (empty ( $this->_tpl_vars['menu_data']['pickup_flag'] ) && ( $this->_tpl_vars['page_identify'] == @PAY )): ?>
								<?php echo $this->_tpl_vars['base_data']['base_list']['target_base_text_mm']; ?>
							...
							<div class="ow_show_work_text ow_show_item">
								<?php echo $this->_tpl_vars['base_data']['base_list']['target_base_text_yy']; ?>
							...
							<div class="ow_show_originally_text ow_show_item">
							<?php if (empty ( $this->_tpl_vars['menu_data']['pickup_flag'] ) && ( $this->_tpl_vars['page_identify'] == @PAY )): ?>
								<?php echo $this->_tpl_vars['base_data']['base_list']['target_base_text_dd']; ?>
