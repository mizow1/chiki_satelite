<?php
/* Smarty version 4.1.1, created on 2024-07-10 16:25:09
  from '/home/users/0/flier.jp-uranai/web/uranai/chiki/webapp/view/index/default_smp/entry.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_668e37556f17b1_12626537',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9516d33a77e7d0eb087726531fd9756821277457' => 
    array (
      0 => '/home/users/0/flier.jp-uranai/web/uranai/chiki/webapp/view/index/default_smp/entry.html',
      1 => 1720596254,
      2 => 'file',
    ),
  ),
...
function content_668e37556f17b1_12626537 (Smarty_Internal_Template $_smarty_tpl) {
				...
				<div class="ow_menu_head">
					<div class="ow_menu_icon">
						<div class="ow_menu_category">
							<img src="img/smp/category/<?php echo $_smarty_tpl->tpl_vars['contents_data']->value['category'];?>
		...
		<div class="ow_entry">
			<div class="ow_sample_intro ow_tac">
				<div class="ow_sample_intro_canvas">
					<img src="img/smp/top/sample_intro_canvas.jpg" alt=""/>
				</div>
				<div class="ow_sample_intro_item ow_sample_intro_confetti">
					<img src="img/smp/top/sample_intro_confetti.png" alt="" title=""/>
				</div>

				<div class="ow_sample_intro_item ow_sample_intro_text">
					<img src="img/smp/top/sample_intro_text.png" alt="この恋もうダメ?!　最近ツイてない…　結婚は諦めた…" title="この恋もうダメ?!　最近ツイてない…　結婚は諦めた…"/>
				</div>
				<div class="ow_sample_intro_item ow_sample_intro_title_1">
					<img src="img/smp/top/sample_intro_title_1.png" alt="絶望的な状態が激変する!" title="絶望的な状態が激変する!"/>
				</div>
				<div class="ow_sample_intro_item ow_sample_intro_title_2">
					<img src="img/smp/top/sample_intro_title_2.png" alt="逆転成功術" title="逆転成功術"/>
				</div>
				<div class="ow_sample_intro_item ow_sample_intro_hikari">
					<img src="img/smp/top/sample_intro_hikari.png" alt="" title=""/>
				</div>
			</div>
			<!-- /.ow_sample_intro -->
			...
			<div class="ow_sub_menu ow_sub_menu_entry">
				<div class="ow_sub_menu_top ow_tac">
					<img class="ow_vab" src="img/smp/entry/sub_menu_top.jpg" alt="鑑定項目" title="鑑定項目">
				</div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
	...
	<?php }?>
			...
			<div class="ow_entry_teach ow_tac">
				<img src="img/smp/top/ow_entry_teach.png" alt="算命学では生年月日を元に運命を算出致します。まずはあなたのことを教えてください。" title="算命学では生年月日を元に運命を算出致します。まずはあなたのことを教えてください。">
			</div>
				...
				<input type="text" style="display:none;">
					<div class="ow_my_form" id="my_form">
						<div class="ow_my_form_top ow_tac">
							<img class="ow_vab" src="img/smp/entry/my_form_top.jpg" alt="あなたについて" title="あなたについて">
						</div>
						<div class="ow_entry_form_mid ow_my_form_mid">
							<div class="ow_form_body">
								<div class="ow_entry_form_item">
									<div class="ow_entry_name">
										<img src="img/smp/top/entry_name.png" alt="お名前" title="お名前">
									</div>
								...
								<div class="ow_entry_form_item">
									<div class="ow_entry_date">
										<img src="img/smp/top/entry_date.png" alt="生年月日" title="生年月日">
									</div>

									<!-- ▽▽▽smp用 生年月日入力▽▽▽ -->
											<div class="ow_entry_form_select_wrap ow_smp_block">
...
?>
								...
								<div class="ow_entry_form_item">
									<div class="ow_entry_seibetu">
										<img src="img/smp/top/entry_seibetu.png" alt="性別" title="性別">
									</div>
	...
	<?php }?>
							...
							<div class="ow_form_btm ow_tac">
								<img class="ow_vat" src="img/smp/entry/my_form_btm.jpg" alt="">
							</div>
						</div>
						<!-- /.ow_my_form -->
	<?php if ($_smarty_tpl->tpl_vars['contents_data']->value['target_count'] == 2) {?>
						<div class="ow_target_form">
							<div class="ow_target_form_top ow_tac">
								<img class="ow_vab" src="img/smp/entry/target_form_top.jpg" alt="あの人について" title="あの人について">
							</div>
...
?>
	...
	<?php }?>
								...
								<!-- /.ow_entry_form_mid -->
								<div class="ow_form_btm ow_tac">
									<img class="ow_vat" src="img/smp/entry/target_form_btm.jpg" alt="">
								</div>
							</div>
							<!-- /.ow_target_form -->
	<?php }?>
...
,'astrology_form')">
											<img src="img/smp/entry/btn_nc.png" alt="一部無料で鑑定する" title="一部無料で鑑定する">
										</a>
									</div>
...
,'astrology_form')">
											<img src="img/smp/entry/btn_submit.png" alt="有料で鑑定する" title="有料で鑑定する">
										</a>
									</div>
									<!-- ▲▲▲有料ボタン▲▲▲ -->
								</div>
...
,'astrology_form')">
											<img src="img/smp/entry/btn_free.png" alt="無料で鑑定する" title="無料で鑑定する">
										</a>
									</div>
									<div class="ow_entry_form_btn_text">
