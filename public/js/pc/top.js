...
$(window).load(function(){
  ...
  $('.ow_header_decoration_1').delay(1900).fadeIn(1500);
...
// --------------------------------------------------------------------
    ...
    $(window).scroll(function(){
      ...
      if (topPos + w_height > ow_sample_intro_pos && ow_sample_intro == 0) {
        ...
        $('.ow_sample_intro_hikari').delay(2600).fadeIn(1500);
        });
          ow_sample_intro = 1;
      }
        ...
        if (topPos + w_height > ow_special_intro_pos && ow_special_intro == 0) {
          $(function(){
            ...
            $('.ow_special_intro_tori').delay(3000).fadeIn(1000);
            $('.ow_special_intro_saru').delay(3400).fadeIn(1000);
            $('.ow_special_intro_usagi').delay(3800).fadeIn(1000);
          });
        ...
        if (topPos + w_height > ow_explanation_1_bg_pos && ow_explanation_1_bg == 0) {
          $(function(){
            $('.ow_explanation_1 .ow_explanation_number').delay(2600).fadeIn(1000);
            $('.ow_explanation_1_title').delay(3000).fadeIn(1000);
            $('.ow_explanation_1 .ow_explanation_text').delay(3600).fadeIn(1000);
        ...
        if (topPos + w_height > ow_explanation_2_bg_pos && ow_explanation_2_bg == 0) {
          $(function(){
            $('.ow_explanation_2 .ow_explanation_number').fadeIn(1000);
            $('.ow_explanation_2_title').delay(800).fadeIn(1000);
            $('.ow_explanation_2 .ow_explanation_text').delay(1200).fadeIn(1000);
