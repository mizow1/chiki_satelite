...
// --------------------------------------------------------------------
    ...
    if($('.ow_result_item_base').length){
      ...
      for(var i=0; i<result_item_count; i++){
         ow_result_item_base[i] = $('.ow_result_item_base .ow_result_body').eq(i).offset().top;
      }
    }
...
// --------------------------------------------------------------------
    ...
    // ow_result_intro
      ...
      for(var i=0; i<result_item_count; i++){
        if(topPos + w_height> ow_result_item_base[i] && result_item_base < result_item_count){
          $(function(){
              $('.ow_result_item_base .ow_result_body_img_card').eq(i).fadeIn(2000);
              $('.ow_result_item_base .ow_result_body_img_hand').eq(i).fadeIn(1500);
              $('.ow_result_item_base .ow_result_body_img_card_title').eq(i).delay(600).animate({'opacity':'1'},1500);
              $('.ow_result_item_base .ow_result_body_text').eq(i).delay(800).animate({'opacity':'1'},2000);
              $('.ow_result_item_base .ow_result_body_img_oldman').eq(i).delay(1100).fadeIn(1500);
            });
    ...
    // ow_result_item_person
      if(topPos + w_height> ow_person_pos_1 && ow_person_1 == 0){
        $(function(){
          $('.ow_result_item_person .ow_result_body_img_card').fadeIn(2000);
          $('.ow_result_item_person .ow_result_body_img_hand').fadeIn(1500);
          $('.ow_result_item_person .ow_result_body_img_card_title').delay(600).animate({'opacity':'1'},1500);
          $('.ow_result_item_person .ow_result_body_text').eq(0).delay(800).animate({'opacity':'1'},2000);
        });
        ow_person_1 = 1;
      }
      ...
      // ow_result_item_calender
        if(topPos + w_height> ow_calender_pos && ow_calender == 0){
          $(function(){
            $('.ow_result_item_calender .ow_result_body_img_card').fadeIn(2000);
            $('.ow_result_item_calender .ow_result_body_img_hand').fadeIn(1500);
            $('.ow_result_item_calender .ow_result_body_img_card_title').delay(600).animate({'opacity':'1'},1500);
            $('.ow_result_item_calender .ow_calender_title').delay(800).animate({'opacity':'1'},2000);
            $('.ow_result_item_calender .ow_result_body_text').delay(800).animate({'opacity':'1'},2000);
            $('.ow_result_item_calender .ow_result_body_img_oldman').delay(1100).fadeIn(1500);
          });
          ow_calender = 1;
        }
        ...
        if(topPos + w_height> ow_gift_nc_pos && ow_gift_nc == 0){
          $(function(){
            ...
            $('.ow_gift_nc .ow_nc_white').delay(3500).animate({'opacity':'1'},2000);
        ...
        // about
          ...
          if(topPos + w_height> ow_card_pos && ow_card == 0){
            $(function(){
              $('.ow_result_card_item_base').delay(800).fadeIn(2000,function(){
                $('.ow_result_card_item_base').delay(800).fadeOut(100);
              });

              $('.ow_result_card_item').delay(3300).fadeIn(50);
            });
            ow_card = 1;
          }
    });
...
// シャッフル終了
  ...
  $('.ow_shaffle_btn_end').eq(index).on('click', function() {
    ...
    // それぞれのカードポジションへ移動
    // 胴
    $('.ow_result_card_bundle_1').eq(index).delay(3500).animate({'top':'10%','left':'78%'},500);
    $('.ow_result_card_bundle_2').eq(index).delay(3500).animate({'top':'10%','left':'64%'},500);
    $('.ow_result_card_bundle_3').eq(index).delay(3500).animate({'top':'10%','left':'92%'},500);
    $('.ow_result_card_bundle_4').eq(index).delay(3500).animate({'top':'24%','left':'78%'},500);
    $('.ow_result_card_bundle_5').eq(index).delay(3500).animate({'top':'24%','left':'64%'},500);
    $('.ow_result_card_bundle_6').eq(index).delay(3500).animate({'top':'24%','left':'92%'},500);
    $('.ow_result_card_bundle_7').eq(index).delay(3500).animate({'top':'38%','left':'78%'},500);
    $('.ow_result_card_bundle_8').eq(index).delay(3500).animate({'top':'38%','left':'64%'},500);
    $('.ow_result_card_bundle_9').eq(index).delay(3500).animate({'top':'38%','left':'92%'},500);
    $('.ow_result_card_bundle_10').eq(index).delay(3500).animate({'top':'52%','left':'78%'},500);
    $('.ow_result_card_bundle_11').eq(index).delay(3500).animate({'top':'52%','left':'64%'},500);
    $('.ow_result_card_bundle_12').eq(index).delay(3500).animate({'top':'52%','left':'92%'},500);

    // 右手
    $('.ow_result_card_bundle_15').eq(index).delay(4000).animate({'top':'17%','left':'51%'},500);
    $('.ow_result_card_bundle_16').eq(index).delay(4000).animate({'top':'31%','left':'51%'},500);
    $('.ow_result_card_bundle_17').eq(index).delay(4000).animate({'top':'45%','left':'51%'},500);
    // 左手
    $('.ow_result_card_bundle_18').eq(index).delay(4000).animate({'top':'17%','left':'105%'},500);
    $('.ow_result_card_bundle_19').eq(index).delay(4000).animate({'top':'31%','left':'105%'},500);
    $('.ow_result_card_bundle_20').eq(index).delay(4000).animate({'top':'45%','left':'105%'},500);
    // 右足
    $('.ow_result_card_bundle_13').eq(index).delay(4500).animate({'top':'66%','left':'64%'},500);
    $('.ow_result_card_bundle_24').eq(index).delay(4500).animate({'top':'79%','left':'70%'},500,function(){
      $(this).addClass('ow_card_rotate');
    });
    $('.ow_result_card_bundle_25').eq(index).delay(4500).animate({'top':'79%','left':'53%'},500,function(){
      $(this).addClass('ow_card_rotate');
    });
    $('.ow_result_card_bundle_26').eq(index).delay(4500).animate({'top':'77%','left':'38%'},500);
    // 左足
    $('.ow_result_card_bundle_14').eq(index).delay(4500).animate({'top':'66%','left':'92%'},500);
    $('.ow_result_card_bundle_28').eq(index).delay(4500).animate({'top':'79%','left':'87%'},500,function(){
      $(this).addClass('ow_card_rotate');
    });
    $('.ow_result_card_bundle_29').eq(index).delay(4500).animate({'top':'79%','left':'104%'},500,function(){
      $(this).addClass('ow_card_rotate');
    });
    $('.ow_result_card_bundle_30').eq(index).delay(4500).animate({'top':'77%','left':'119%'},500);
    // 外周
    $('.ow_result_card_bundle_21').eq(index).delay(5000).animate({'top':'10%','left':'38%'},500);
    $('.ow_result_card_bundle_22').eq(index).delay(5000).animate({'top':'10%','left':'119%'},500);
    $('.ow_result_card_bundle_23').eq(index).delay(5000).animate({'top':'52%','left':'38%'},500);
    $('.ow_result_card_bundle_27').eq(index).delay(5000).animate({'top':'52%','left':'119%'},500);
