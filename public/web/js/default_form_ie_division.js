...
function loadCookie(target_flag){
	...
	var division1_obj = document.getElementById('division1');
...
//	var pref_obj = document.getElementById('pref');
	...
	for(i=0;i<division1_obj.options.length;i++){
		if(division1_obj.options[i].value==cookie_data['division1']){
			division1_obj.options[i].selected = 1;
		};
	}
	for(i=0;i<hh1_obj.options.length;i++){
		if(hh1_obj.options[i].value==cookie_data['hh1']){
			hh1_obj.options[i].selected = 1;
		};
	}
	for(i=0;i<ii1_obj.options.length;i++){
		if(ii1_obj.options[i].value==cookie_data['ii1']){
			ii1_obj.options[i].selected = 1;
		};
	}
	...
	if(target_flag==2){
		...
		var division2_obj = document.getElementById('division2');
		var hh2_obj = document.getElementById('hh2');
		var ii2_obj = document.getElementById('ii2');
		...
		for(i=0;i<division2_obj.options.length;i++){
			if(division2_obj.options[i].value==cookie_data['division2']){
				division2_obj.options[i].selected = 1;
			};
		}
		for(i=0;i<hh2_obj.options.length;i++){
			if(hh2_obj.options[i].value==cookie_data['hh2']){
				hh2_obj.options[i].selected = 1;
			};
		}
		for(i=0;i<ii2_obj.options.length;i++){
			if(ii2_obj.options[i].value==cookie_data['ii2']){
				ii2_obj.options[i].selected = 1;
			};
		}
...
// クッキーの発行（書き込み）
	...
	document.cookie = 'division1='   + document.getElementById('division1').value+ " ; expires=" + expires;
	document.cookie = 'hh1='   + document.getElementById('hh1').value+ " ; expires=" + expires;
	document.cookie = 'ii1='   + document.getElementById('ii1').value+ " ; expires=" + expires;
//	document.cookie = 'pref='   + document.getElementById('pref').value+ " ; expires=" + expires;
	...
	if(target_flag==2){
		...
		document.cookie = 'division2='   + document.getElementById('division2').value+ " ; expires=" + expires;
		document.cookie = 'hh2='   + document.getElementById('hh2').value+ " ; expires=" + expires;
		document.cookie = 'ii2='   + document.getElementById('ii2').value+ " ; expires=" + expires;
...
// クッキーの発行（書き込み）
	...
	document.cookie = 'division1' + "= 東京都; expires=" + expires;
	document.cookie = 'hh1' + "= 12; expires=" + expires;
	document.cookie = 'ii1' + "= 00; expires=" + expires;
	...
	document.cookie = 'division2' + "= 0; expires=" + expires;
	document.cookie = 'hh2' + "= 0; expires=" + expires;
	document.cookie = 'ii2' + "= 0; expires=" + expires;
